...
export default class AddFood extends React.Component {
  ...
  remove =(id)=> {
    if (typeof(this.state.foodSelected[id])=="undefined") Alert.alert("Sản phẩm này chưa được chọn");
  ...
  add=(id)=>{
    if (typeof(this.state.foodSelected[id])=="undefined") this.state.foodSelected[id]=0;
    this.state.foodSelected[id]=this.state.foodSelected[id]+1;
    console.log(this.state.foodSelected);
    ...
    return (
      ...
      <View style={styles.item}>
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          style={styles.btn1}
          setvalue={this.state.foodSelected[item.id]=0}
